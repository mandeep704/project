...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2020 at 09:14 AM
...
(2, 'PHP and MySQL ', 'Larry Ullman', 'Easy visual approach uses demonstrations and real-world examples to guide you step by step through advanced techniques for dynamic Web development using PHP and MySQL', 58, 54, 'images/php.jpg'),
...
(4, 'Google Analytics Breakthrough', 'Feras Alhlou, Shiraz Asif, Eric Fettman', 'Google Analytics Breakthrough is a much-needed comprehensive resource for the world\'s most widely adopted analytics tool. Designed to provide a complete, best-practices foundation in measurement strategy, implementation, reporting, and optimization, this book systematically demystifies the broad range of Google Analytics features and configurations', 60, 69, 'images/Google_Analytics.jpg'),
(5, 'Adobe Photoshop CC ', 'Andrew Faulkner, Conrad Chavez', 'Creative professionals seeking the fastest, easiest, most comprehensive way to learn Adobe Photoshop choose Adobe Photoshop CC Classroom in a Book (2017 release) from Adobe Press. The 15 project-based lessons in this book show users step-by-step the key techniques for working in Photoshop and how to correct, enhance, and distort digital images, create image composites, and prepare images for print and the web', 62, 69, 'images/adobe.jpg'),
...
INSERT INTO `buyer` (`id`, `First_name`, `Last_name`, `Payment`) VALUES
(1, 'Mandeep', 'Kaur', 'Credit card'),
(2, 'jazz', 'jazz', 'Credit card'),
(3, 'jazz', 'Kaur', 'Credit card'),
(4, 'sdf', 'dgh', 'Credit card');
